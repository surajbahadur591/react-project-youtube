  ...
  return (
    <div className="sticky text top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black text-white">
      ...
      <div className="group flex items-center">
          <div className="flex h-8 md:h-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 ml-5 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
        ...
        <div className="flex items-center">
          <div className="hidden md:flex">
            ...
            <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
              <img src="https://xsgames.co/randomusers/assets/avatars/female/76.jpg" alt="profile-imgage"/>
            </div>
